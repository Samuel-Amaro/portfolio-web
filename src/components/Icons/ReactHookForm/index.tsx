...
export default function ReactHookForm({className} : {className?: string}) {
    return (
        <svg className={className} viewBox="0 0 100 100">
            ...
            <path d="M71.6,45.92H54a1,1,0,0,0,0,2H71.6a1,1,0,0,0,0-2Z" /*style="transform: translateX(-25px);"*/></path>
            <path d="M71.6,45.92H54a1,1,0,0,0,0,2H71.6a1,1,0,0,0,0-2Z"></path>
            <path d="M71.1,69.49H53.45a1,1,0,1,0,0,2H71.1a1,1,0,0,0,0-2Z" /*style="transform: translateX(-25px);"*/></path>
