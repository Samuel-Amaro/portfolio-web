...
type PropsSelect = {
  ...
  filterProjects: ({filter, by}: Filter) => void
};
...
export default function Index({optionsSelect, filterProjects}: PropsSelect) {
  ...
  function getActionFromKey(event: React.KeyboardEvent<HTMLDivElement>): number {
    ...
    if (document.querySelector(".select__combo-option--selected")) {
        if (isScrollable(document.querySelector(`[role="listbox"]`) as Element)) {
          ...
          maintainScrollVisibility(
            document.querySelector(".select__combo-option--selected") as HTMLElement,
        ...
        if (
          !isElementInView(
            document.querySelector(".select__combo-option--selected") as Element
          )
        ) {
            const e =  document
            .querySelector(".select__combo-option--selected") as HTMLElement;
  ...
  useEffect(() => {
    filterProjects({ filter: optionSelected.option, by: "tecnologys" });
  }, [optionSelected]);
