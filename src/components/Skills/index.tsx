...
type PropsSkills = {
  refSectionSkills: React.RefObject<HTMLElement>
};

export default function Skills({refSectionSkills}: PropsSkills) {
  return (
    <Section nameSection="skills" refSection={refSectionSkills}>
